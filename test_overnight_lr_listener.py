...
from training.agents import SRPolicyNet, GSPolicyNet, GSPolicyNetLSTM, SRGSPolicyNet#will happen in training script
...
for LR_LISTEN in [1e-2, 1e-4, 1e-5, 1e-6, 1e-7]:
    ...
    if not CONTINUE:
        ...
        NOTE="learning rate for listener"#input("describe the run: ")#"lr tuning for mixed length (and classifiction)"
